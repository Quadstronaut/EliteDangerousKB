...
- **Base cost:** approximately 65–75 million CR (varies by station)
- **Landing pad:** Medium (can dock at outposts)
- **Hardpoints:** 4 × Medium + 2 × Small (excellent medium-ship firepower)
- **Max jump range (A-rated, empty):** approximately 30–35 ly before engineering
...
- 4 × Medium Multicannons (Corrosive + Incendiary experimentals) for hull shredding
- 2 × Small Pulse Lasers (Efficient experimental) for shield stripping
- Or: mixed loadout with 2 × Medium Beam Lasers + 2 × Medium Multicannons
