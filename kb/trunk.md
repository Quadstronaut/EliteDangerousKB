...
See [[ships/sidewinder]] for the Sidewinder (Faulcon DeLacy free starter; the cheapest (4,588 CR) and lightest (25 t) hull in the KB, class-2 core, 2 Small hardpoints, roll 110 (ties the Vulture, now 2nd to the Eagle Mk II’s 120), no Military slot, no rank gate — the universal baseline ship).
...
See [[ships/adder]] for the Adder (Zorgon Peterson cheap small-pad multipurpose; 2nd-lightest hull (35 t), class-3 FSD + class-3 fuel tank for budget jump range, 1 Medium + 2 Small hardpoints, seven optionals, no Military slot, no rank gate — the budget early-game explorer/hauler).
